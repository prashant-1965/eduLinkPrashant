package com.cts.course_service.security.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        boolean isPublicPath = path.startsWith("/course/checkCourseExistByCourseId/") ||
                path.startsWith("/course/findCourseTitleByCourseId/") ||
                path.equals("/course/findAllAvailableCourse") ||
                path.startsWith("/course/courseCount/") ||
